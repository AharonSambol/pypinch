...
use std::ptr;
use crate::utils::consts::{BOOL_FLAG, BYTES_FLAG, CONSISTENT_TYPE_LIST_FLAG, DICT_FLAG, EMPTY_BYTES_FLAG, EMPTY_DICT_FLAG, EMPTY_LIST_FLAG, EMPTY_STR_FLAG, ENDING_FLAG, FALSE_FLAG, FLOAT_FLAG, INT_FLAG, LIST_FLAG, NEGATIVE_INT_FLAG, NULL_FLAG, POINTER_FLAG, POSITIVE_INT_FLAG, small_int, STR_FLAG, STR_KEY_DICT_FLAG, TRUE_FLAG};
const NUMBER_BASE: u8 = 255;
